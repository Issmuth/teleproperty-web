    ...
    >
      <div className="space-y-5 px-2 lg:px-0">
        ...
        <div className="space-y-2">
          <label className="text-sm md:text-base font-black text-gray-900 dark:text-white">
            Full Name
          </label>
          <input
            type="text"
        ...
        <div className="flex gap-2.5">
          <div className="w-[88px] md:w-[96px] min-h-[48px] md:min-h-[52px] bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl md:rounded-2xl flex items-center justify-center gap-2 flex-shrink-0">
            <Flag size={16} className="text-gray-900 dark:text-white md:w-5 md:h-5" strokeWidth={2.5} />
        ...
        {/* Continue Button */}
        <button
          onClick={() => router.push(`/auth/verify?redirectTo=${encodeURIComponent(redirectTo)}`)}
